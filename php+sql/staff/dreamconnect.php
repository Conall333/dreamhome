...
function html_begin($title, $h1)
{
	...
	print("<header>");
		print("<h1>Staff Operations</h1>");
	print("</header>");
		
	print("<nav>");
    	print("<ul>");
			print("<li><a href='../index.html'>Home</a></li>");
			print("<li><a href='staff_operations.html'>Staff Operations</a></li>");
			print("<li><a href='../branch/branch_operations.html'>Branch Operations</a></li>");
    	print("</ul>");
	print("</nav>");
